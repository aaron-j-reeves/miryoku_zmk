...
U_MT(LALT, TILDE), &kp A,             U_LT(U_FUN, S),    U_LT(U_NUM, D),    U_LT(U_SYM, F),    &kp G,             &kp H,             U_LT(U_MOS, J),  U_LT(U_NAV, K),    U_LT(U_MEDIA, L),  &kp COLON,   \
U_MT(LSHFT, TAB),  &kp X,             &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH,\
U_MT(LCTRL, D),    U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           &kp SPACE,         &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,
