...
&kp GRAVE,         U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    &kp F,             &kp G,             &kp H,             &kp J,             U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   &kp SQT,           \
&kp TAB,           &kp Z,             &kp X,             &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           U_MT(RALT, FSLH),  U_MT(RALT, RPAR), \
U_LT(U_BUT, LPAR), U_MT(RALT, U_NP),  U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOS, SPACE),U_LT(U_NAV, LEFT),  U_LT(U_MEDIA, DOWN),&kp DOWN,           U_LT(U_BUT, RIGHT)
...
#define MEH(MOD, TAP) &meh MOD TAP
